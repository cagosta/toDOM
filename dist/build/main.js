...
/**
 * toDOM version: "0.0.2" Copyright (c) 2011-2012, Cyril Agosta ( cyril.agosta.dev@gmail.com) All Rights Reserved.
...
requirejs.config( {
    ...
    paths: {
        ...
        app: 'bower_components/engineDetector/app'
    }
} )
...
if ( synchronous ) { // case standalone
    ...
    var toDOM = requirejs( 'toDOM/toDOM' )

    engine.exports( 'toDOM', toDOM )


} else {

    requirejs( [ 'toDOM/toDOM' ], function( toDOM ) {
        engine.exports( 'toDOM', toDOM )
    } )

}
;
define("toDOM/main", function(){});
}());